...
EMAIL_BACKEND = os.getenv("EMAIL_BACKEND", "contacts.email_backend.BrevoEmailBackend")
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL") or BREVO_SENDER_EMAIL or "bokebi@localhost"
